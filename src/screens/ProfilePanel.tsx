...
export function ProfilePanel(props: ProfilePanelProps) {
  return (
    <>
      ...
      <input className="bg-surface text-on-surface border border-outline-variant rounded h-8 pl-[30px] pr-sm text-body-sm focus:border-primary-container focus:ring-1 focus:ring-primary-container focus:outline-none w-64 placeholder:text-on-surface-variant transition-colors" placeholder="Search..." type="text" />
      </div>
